...
def generate_collections_rdf(source_file:str, output_file:str) -> None:
    ...
    importer.import_collections(source_data)
    importer.export_collections(out_file)
...
def parse_args(args):
    ...
    """
    parser = argparse.ArgumentParser(description="process collection csv data into rdf")
    parser.add_argument(
        "--version",
        action="version",
...
def main(args):
    ...
    generate_collections_rdf(args.source, args.outfile)
